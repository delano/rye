...
The easiest way to work with Rye is to authorize your remote accounts for passwordless logins (otherwise you'll be prompted for a password for every connection). Rye comes with an executable called <tt>rye</tt> to help with this.
