...
== EXAMPLE 5 -- ERROR HANDLING
    ...
    # Rye follows the standard convention of taking exception to non-zero 
    # exit code. It raises a Rye::CommandError. In this case, rye.test is
    # not found by the ls command. 
    begin
      rbox.ls('rye.test')
