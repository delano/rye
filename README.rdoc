...
Here are some examples (which are also running in bin/try):
...
[OpenSSH key creation HOWTO]	https://wiki.systemsx.ch/display/ITDOC/OpenSSH+key+creation+HOWTO
[OpenSSH key management, Part 1]	http://www.ibm.com/developerworks/library/l-keyc.html
[OpenSSL command-line HOWTO]	http://madboa.com/geek/openssl/
== Credits
